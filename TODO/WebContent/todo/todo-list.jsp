				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav me-auto mb-2 mb-lg-0">
						<li class="nav-item"><a class="nav-link"
							href="<%=request.getContextPath()%>/todos?action=list">Todo 리스트</a></li>
					</ul>
				...
				<c:forEach var="todo" items="${listTodo}">
					<tr>
						...
						<td>
							...
							<a href="<%=request.getContextPath()%>/todos?action=delete=<c:out value='${todo.id}'/>" class="btn btn-danger btn-sm">삭제</a>
						</td>
					</tr>
				</c:forEach>
			</tbody>
